...
public class ExcelHandler implements DBActionEngine{
	...
	public String getData(String columnName) {
		...
		dataRow = ExcelHandler.getDataInstance().get(GlobalVariables.currentFeature);
	...
	public void setData(String columnName, String cellValue) {
		...
		try {
			...
			strQuery = String.format("Update %s Set %s=%s where FeatureName=%s",
					GlobalVariables.configProp.getProperty("environment"), columnName, cellValue, GlobalVariables.currentFeature);
